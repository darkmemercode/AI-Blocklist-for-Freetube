...
3. Not mandatory: Go to **Settings** -> **Distraction Free** and untick the **Show Added Items**-Box to make using your settings easier without showing all 20k channels.
